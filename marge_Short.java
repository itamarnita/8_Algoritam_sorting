...
public class mergesort {
    ...
    public static void main(String[] args) {
        ...
        mergesort mergesort = new mergesort(integerArrayList);

        System.out.print("Array Sebelum Merge Sort : ");
        for (Integer integer : mergesort.getArrayAfterSorting()) {
            System.out.print(integer+" ");
        }

        System.out.println();

        mergesort.divideArrayElements(0, integerArrayList.size() - 1);
